...
cmp.setup({
  ...
  mapping = cmp.mapping.preset.insert({
	...
	['<Tab>'] = cmp.mapping.select_next_item(select_opts), -- move to the next completion item
	['<S-Tab>'] = cmp.mapping.select_prev_item(select_opts), -- move to the previous completion item
